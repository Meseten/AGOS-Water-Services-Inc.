        ...
        <div className="p-4 sm:p-6 bg-white rounded-xl shadow-xl animate-fadeIn leading-relaxed text-gray-700">
            ...
            <div className="prose prose-sm max-w-none">
                <p>
                    ...
                    AGOS Water Services, Inc. ("AGOS", "us", "we", or "our") customer portal (the "Service" or "Portal").
                </p>
                <p>
                ...
                <ul>
                    <li>
                        To use this Service, you must be a registered customer of AGOS Water Services, Inc.
                ...
                <p>
                    ...
                    functionality are and will remain the exclusive property of AGOS Water Services, Inc. and its
                    ...
                    with any product or service without the prior written consent of AGOS.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        AGOS is not a bank or financial institution. All payment card transactions are
                    ...
                    <li>
                        ...
                        overpayments, or refunds must be directed to AGOS Customer Service and will be
                ...
                <p>
                    AGOS does not warrant that (a) the Service will function uninterrupted, secure, or
                ...
                <p>
                    ...
                    the official records held by AGOS Water Services, Inc. shall be deemed correct
                    and final.
                </p>

                <h4>6. Limitation of Liability</h4>
                <p>
                    In no event shall AGOS, nor its directors, employees, partners, or agents,
